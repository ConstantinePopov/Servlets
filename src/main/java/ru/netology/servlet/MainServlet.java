...
public class MainServlet extends HttpServlet {
    ...
    private static final String APIPOSTSDPLUS = "/api/posts/\\d+";
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            if (method.equals(GET) && path.matches(APIPOSTSDPLUS)) {
                // easy way
            ...
            if (method.equals(DELETE) && path.matches(APIPOSTSDPLUS)) {
                // easy way
                final var id = Long.parseLong(path.substring(path.lastIndexOf(SLASH)));
